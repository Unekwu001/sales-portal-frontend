    ...
    <div class="main-container">
        ...
        <div class="form-container">
            ...
            <p class="body">ipNX will collect and process your personal data to provide the services you subscribed to. 
                ...
                <!-- <p style="color: #DA1919" v-if="v$.localConsent.$error">You have to check to give consent.</p> -->
            </p>
            ...
            <form action="" class="row g-3 form">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 comment">
                    Upload Scan Letter of Introduction from Organisation (JPEG,PNG)
                </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 comment">
                    Upload Certificate of Incorporation/Registration (JPEG,PNG)
                </div>
   ...
   import { required } from '@vuelidate/validators'
    ...
    setup (props, {emit}) {
        ...
        const certOfIncorpInput = ref('');
            ...
            return {state, prevStep, submitForm, 
                choosePassport, chooseGovtId, chooseUtilityBill, chooseLetterOfIntro, chooseCertOfIncorp,
            handlePassport, handleGovtId, handleUtilityBill, handleLetterOfIntro, handleCertOfIncorp,
            passportInput, govtIdInput, utilityInput, certOfIncorpInput, letterOfIntroInput
            }
        }
    }
</script>
