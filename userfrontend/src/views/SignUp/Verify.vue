<template>
    <div class="main-container">
        <nav>
            ...
            <div class="custom-modal">
              ...
              <div class="modal-body">
                  <h5 class="modal-heading">Account Verified Successfully!</h5>
                  <p class="modal-text">
                    Your account has been successfully verified and we are thrilled to confirm that ipNX is in your area.
                    Simply click on login using your email the next time you visit our portal. Click 'Continue' to continue your activation.
                    Get ready to experience seamless connectivity with ipNX. Welcome aboard!
                 </p>
              </div>
              <div class="modal-btn" @click="VerifySuccess()">
        ...
        <div class="mini-container">
            ...
            <!-- <p v-if="errorMessage" style="color: #DA1919">{{ errorMessage }}</p> -->
...
const apiUrl = process.env.VUE_APP_API_URL
    ...
    export default {
        ...
        setup(props, {emit}){
                ...
                if (!token) {
                    try{
                        ...
                        if (response.data.message === 'user exists') {
                            ...
                            router.push({name: 'VerifySignUp', query: {email: userEmail}})
                            state.firstDigit = ''
                            state.secondDigit = ''
                            state.thirdDigit = ''
                            state.fourthDigit = ''
            ...
            return { state, v$, clickLogo, isLoading, resendOTP, verify, VerifySuccess, errorMessage, isModalVisible, resendMessage, hasError }
