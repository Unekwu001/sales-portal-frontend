          ...
          <div class="modal fade" id="myModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-bs-backdrop="static">
            <div class="modal-dialog modal-dialog-centered">
                ...
                <div class="modal-body">
                    <h5 class="modal-heading">Internal Server Error</h5>
                    <p class="modal-text">
                        <p class="heading">This page can not be reached</p>
                        <p class="sub-heading">Please check your internet connection and reload this page </p>
                    </p>
                </div>
